...
import { DeploymentCondition, DeploymentUpdateStrategy } from '@topology-utils/types/commonTypes';
import { PodTemplate } from '@topology-utils/types/podTypes';
...
export type K8sWatchResourceGeneric = {
