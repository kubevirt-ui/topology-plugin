import { K8sResourceCommon, ObjectMetadata, Selector } from '@openshift-console/dynamic-plugin-sdk';
...
import { K8sResourceCondition, K8sResourceKind } from '@topology-utils/types/k8s-types';
