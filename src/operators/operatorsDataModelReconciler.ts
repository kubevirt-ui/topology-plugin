...
import isOperatorBackedKnResource from '../utils/hooks/isOperatorBackedResource/isOperatorBackedKnResource';
import { getDefaultOperatorIcon, getImageForCSVIcon } from '../utils/icon-utils';
import {
