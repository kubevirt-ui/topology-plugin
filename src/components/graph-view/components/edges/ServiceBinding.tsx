...
import { getComputedServiceBindingStatus } from '@topology-utils/service-binding-plugin-utils';
import { ComputedServiceBindingStatus } from '@topology-utils/types/service-binding-types';
...
const ServiceBinding: FC<ServiceBindingProps> = (props) => {
