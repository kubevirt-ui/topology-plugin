...
import { calculateRadius, getPodStatus } from '@topology-utils/pod-utils';
import { AllPodStatus, PodRCData } from '@topology-utils/types/podTypes';
...
const WorkloadPodsNode: FC<WorkloadPodsNodeProps> = observer(function WorkloadPodsNode({
  ...
  element,
  children,
  urlAnchorRef, // eslint-disable-line @typescript-eslint/no-unused-vars
  canDrop,
  dropTarget,
  dropTooltip,
  contextMenuOpen,
