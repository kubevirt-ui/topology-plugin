...
import { kindToAbbr } from '@topology-utils/common-utils';
...
const ForwardSvgResourceIcon: FC<ResourceIconProps> = ({ kind, x, y, leftJustified }, iconRef) => {
...
const SvgResourceIcon = forwardRef(ForwardSvgResourceIcon);
