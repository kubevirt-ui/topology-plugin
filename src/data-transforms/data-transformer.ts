...
import { createOverviewItemForType } from '@topology-utils/resource-utils';
...
import { KialiNode, TopologyDataModelDepicted, TrafficData } from '../utils/types/topology-types';
