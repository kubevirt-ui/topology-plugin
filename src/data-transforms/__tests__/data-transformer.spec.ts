...
import { MockBaseResources, sampleDeployments } from '@topology-utils/__tests__/test-resource-data';
import { getImageForIconClass } from '@topology-utils/logos';
import { TrafficData, WorkloadData } from '@topology-utils/types/topology-types';
...
import { baseDataModelGetter, getTrafficConnectors } from '../data-transformer';
...
describe('data transformer ', () => {
  ...
  beforeEach(() => {
    mockResources = cloneDeep(MockBaseResources);
  });
