  ...
  beforeEach(() => {
    ...
    graphWrapper = mount(
      <ConnectedTopologyView
        ...
        application={''}
        eventSourceEnabled
        onSelectTab={() => {}} // eslint-disable-line @typescript-eslint/no-empty-function
        onSupportedFiltersChange={() => {}} // eslint-disable-line @typescript-eslint/no-empty-function
        onSupportedKindsChange={() => {}} // eslint-disable-line @typescript-eslint/no-empty-function
      />,
    );
  });
