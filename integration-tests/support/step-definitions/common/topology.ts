...
import { createForm, navigateTo, perspective, projectNameSpace } from '../../pages/app';
...
} from '../../pages/functions/installOperatorOnCluster';
...
Given(
  ...
  (componentName: string, resourceType = 'Deployment') => {
    createGitWorkload(
...
Given(
  ...
  (componentName: string, resourceType = 'Deployment', applicationGroupings: string) => {
    createGitWorkload(
      'https://github.com/sclorg/nodejs-ex.git',
      componentName,
      resourceType,
