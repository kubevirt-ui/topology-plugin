...
import { devNavigationMenu, operators, resources, switchPerspective } from '../../constants/global';
import { pageTitle } from '../../constants/pageTitle';
import { chartAreaPO } from '../../page-objects/chart-area-po';
import { topologyPO, typeOfWorkload } from '../../page-objects/topology-po';
import { app, navigateTo, perspective, projectNameSpace, yamlEditor } from '../../pages/app';
import {
  addToProjectOptions,
...
import { createOperatorBacked } from '../../pages/functions/createOperatorBacked';
...
Given(
  ...
  (resourceType: string, componentName = `${resourceType.toLowerCase()}-ex-git`) => {
    navigateTo(devNavigationMenu.Add);
    createGitWorkload(
